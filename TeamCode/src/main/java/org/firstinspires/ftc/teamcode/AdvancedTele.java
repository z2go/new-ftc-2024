...
//    private Servo claw;
    ...
    public void init() {
        ...
        releaseIntake = hardwareMap.get(Servo.class, "releaseIntake");
    ...
    @Override
    public void start() {
        releaseIntake.setPosition(0);
        runtime.reset();
        // This is optional: Here we add code to be run once when the PLAY button is hit
    }
    @Override
    public void loop() {
        telemetry.addData("LiftPos",leftSlide.getCurrentPosition());
        ...
        leftSlide.setPower(rightTrigger-leftTrigger);
        rightSlide.setPower(rightTrigger-leftTrigger);
